...
export const AddResidentialInfo = () => {
  const { residentialInfoForm, setCandidateActivePage, getResidentialInfo, scrollToTop } = useProfileContext();
    ...
    <section className="container add-residential-info ">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Box className="input-section ">
          ...
          <TextInput label="City" className="inputClass" {...residentialInfoForm.getInputProps('city')} withAsterisk />
        </Box>
        <Box className="input-section ">
